...
public final class PermissionUtils {
    ...
    public String[] checkPermission() {
        ...
        for (String permission : permissions) {
            int checkSelfPermission = ContextCompat.checkSelfPermission(MyApplication.getInstance().getContext(), permission);
    ...
    public boolean isNotificationEnabled() {
        AppOpsManager mAppOps = (AppOpsManager) MyApplication.getInstance().getContext().getSystemService(Context.APP_OPS_SERVICE);
        ApplicationInfo appInfo = MyApplication.getInstance().getContext().getApplicationInfo();
        String pkg = MyApplication.getInstance().getContext().getApplicationContext().getPackageName();
        int uid = appInfo.uid;
