...
public class EncryptUtils {
     ...
     */
    public String AES_MODE = "AES/ECB/PKCS5Padding";
     ...
     * @return 密文
     */
    public String encryptAES(String content, String pass) throws Exception {
     ...
     * @return 明文
     */
    public String decryptAES(String content, String pass) throws Exception {
