...
public class AppInfo {
    ...
    public static String getPackageName() {
        String packageName = MyApplication.getInstance()
    ...
    * @return
    ...
    public static String getVersionName() {
        String versionName = "";
        try {
            versionName = MyApplication.getInstance()
                    .getContext().getPackageManager()
    ...
    /**
     * 获取清单文件<meta-data/> apihost的数据
     * @return
     */
    public static String apiHost() {
        String ahiHost = "";
        try {
            ApplicationInfo appInfo = MyApplication.getInstance()
                    .getContext()
                    .getPackageManager()
    ...
    public static void startApp(String packageName) {
        ...
        MyApplication.getInstance().getContext().
                startActivity(MyApplication.getInstance().getContext()
    ...
    public static boolean isRunningForeground() {
        ActivityManager am = (ActivityManager) MyApplication.getInstance().getContext().getSystemService(Context.ACTIVITY_SERVICE);
